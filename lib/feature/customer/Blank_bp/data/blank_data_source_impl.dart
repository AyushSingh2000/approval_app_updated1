...
import 'modal/get_customer_blank_modal.dart';

const DEBUG = true;

class BlankBpDataSourceImpl implements BlankBpDataSourceRepository {
  @override
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 202) {
        ...
        final Map<String, dynamic> jsonMap =
            jsonResponse['CustomerList_ApproveBlanks'];
        final List<BpDetail_Blank> data = jsonMap.values
            .map((entry) => BpDetail_Blank.fromJson(entry))
            .toList();
