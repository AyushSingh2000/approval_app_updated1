...
class BP_PostModel_test {
  ...
  factory BP_PostModel_test.fromMap(Map<String, dynamic> map) {
    return BP_PostModel_test(
      ...
      BPAddresses: map['BPAddresses'] != null
          ? List<bPAddresses>.from(
              (map['BPAddresses'] as List<int>).map<bPAddresses?>(
                (x) => bPAddresses.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
  ...
  factory BP_PostModel_test.fromJson(String source) =>
      BP_PostModel_test.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class bPAddresses {
  ...
  factory bPAddresses.fromMap(Map<String, dynamic> map) {
    return bPAddresses(
      AddressName:
  ...
  factory bPAddresses.fromJson(String source) =>
      bPAddresses.fromMap(json.decode(source) as Map<String, dynamic>);
}
