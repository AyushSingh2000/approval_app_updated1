...
class EditRejectedModel {
  ...
  String? U_TRPCRBY;
  String? U_TRPADBS;
  List<bPAddresses_rejected>? BPAddresses;
  ...
  factory EditRejectedModel.fromMap(Map<String, dynamic> map) {
    return EditRejectedModel(
      ...
      BPAddresses: map['BPAddresses'] != null
          ? List<bPAddresses_rejected>.from(
              (map['BPAddresses'] as List<int>).map<bPAddresses_rejected?>(
                (x) => bPAddresses_rejected.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
      ContactEmployees: map['ContactEmployees'] != null
          ? List<contactEmployees>.from(
              (map['ContactEmployees'] as List<int>).map<contactEmployees?>(
                (x) => contactEmployees.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
    );
  ...
  factory EditRejectedModel.fromJson(String source) =>
      EditRejectedModel.fromMap(json.decode(source) as Map<String, dynamic>);
}

class bPAddresses_rejected {
  String? AddressName;
  String? AddressType;
  String? AddressName2;
  String? AddressName3;
  ...
  factory bPAddresses_rejected.fromMap(Map<String, dynamic> map) {
    return bPAddresses_rejected(
      AddressName:
  ...
  factory bPAddresses_rejected.fromJson(String source) =>
      bPAddresses_rejected.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class contactEmployees {
  ...
  factory contactEmployees.fromMap(Map<String, dynamic> map) {
  ...
  factory contactEmployees.fromJson(String source) =>
      contactEmployees.fromMap(json.decode(source) as Map<String, dynamic>);
}
