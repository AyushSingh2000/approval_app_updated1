...
class EditRejectedCustomerPage3 extends StatefulWidget {
  const EditRejectedCustomerPage3({super.key});

  @override
  State<EditRejectedCustomerPage3> createState() =>
      _EditRejectedCustomerPage3State();
}

class _EditRejectedCustomerPage3State extends State<EditRejectedCustomerPage3> {
