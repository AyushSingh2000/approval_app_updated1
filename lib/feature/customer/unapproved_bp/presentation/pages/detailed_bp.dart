                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (uac.res
                                                                        ...
                                                                        uac.sendEmail(
                                                                          subject:
                                                                              'Customer Master Creation Approval Confirmation | Approved By ${lc.userBy}',
                                                                          message:
                                                                              ...
                                                                              children: [
                                                                                Center(
                                                                                  child: ElevatedButton(
                                                                                      onPressed: () async {
                                                                                        uac.load_rejected.value = true;

                                                                                        var res = await uac.updateBPDetailsData(widget.code, "Rejected");
                                                                                        uac.load_rejected.value = false;
                                                                                        if (uac.res.value == "Success") {
                                                                                          print('!!!!!!!!Rejected');
                                                                                          await uac.getUn_ApprovedCustomerData();
                                                                                          uac.filterData_UN('');
                                                                                          ...
                                                                                          uac.GetBPUN_ApprovalStatusList.refresh();
                                                                                          uac.filteredData_unApproved.refresh();
                                                                                          ac.GetBPApprovalStatusList.refresh();
                                                                                          Navigator.of(context).pop();
                                                                                          uac.sendEmail_Rejected(subject: ' Customer Master Creation Request Rejected | Rejected By ${lc.userBy}', message: 'We have rejected the new Customer Master and below are the details of the customer along with the comments for your immediate reference.', cvi: 'Customer', reqestOrApproval: 'Approved By', cardCode: '${widget.code}', cardName: '${widget.name}', groupName: '${widget.group}', db: '${widget.db}', requestedBy: '${widget.requestedBy}');
                                                                                        } else {
                                                                                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Un-Successfull')));
                                                                                        }
                                                                                      },
                                                                                      style: ButtonStyle(
                                                                                      ...
                                                                                      child: uac.load_rejected.value == true
                                                                                          ? Container(
                                                                                              height: 25,
                                                                                              width: 25,
