...
import '../data/model/original_item.dart';

class EditRejectedItemsController extends GetxController {
  EditRejectedItemDataSourceImpl itemDataSourceImpl =
      EditRejectedItemDataSourceImpl();
  ...
  Future postItemMaster() async {
    ...
    try {
      ...
      EditItemModel itemModel = EditItemModel(
  ...
  Future postAlternativeItem() async {
    ...
    try {
      EditOriginalItemModel originalItemModel =
          EditOriginalItemModel(AlternativeItems: [
