...
class EditItemModel {
  ...
  factory EditItemModel.fromMap(Map<String, dynamic> map) {
  ...
  factory EditItemModel.fromJson(String source) =>
      EditItemModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
