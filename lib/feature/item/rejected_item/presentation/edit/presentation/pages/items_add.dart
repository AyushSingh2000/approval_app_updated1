...
class editRejectedItemsPage extends StatefulWidget {
  final List list;
  const editRejectedItemsPage({super.key, required this.list});

  @override
  State<editRejectedItemsPage> createState() => _editRejectedItemsPageState();
}
