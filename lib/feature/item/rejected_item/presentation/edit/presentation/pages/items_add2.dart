...
class editRejectedItemsPage2 extends StatefulWidget {
  const editRejectedItemsPage2({super.key});

  @override
  State<editRejectedItemsPage2> createState() => _editRejectedItemsPage2State();
}

class _editRejectedItemsPage2State extends State<editRejectedItemsPage2> {
  ...
  EditRejectedItemsController itemsController =
      Get.find<EditRejectedItemsController>();
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          Obx(() {
            final WhseList = Get.find<EditRejectedItemsController>()
                .WhseList
