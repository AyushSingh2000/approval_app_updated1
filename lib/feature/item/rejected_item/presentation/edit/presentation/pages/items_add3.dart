...
class editRejectedItemsPage3 extends StatefulWidget {
  const editRejectedItemsPage3({super.key});

  @override
  State<editRejectedItemsPage3> createState() => _editRejectedItemsPage3State();
}

class _editRejectedItemsPage3State extends State<editRejectedItemsPage3> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Obx(
              () {
                final BPdataList = Get.find<EditRejectedItemsController>()
                    .BPdataList
