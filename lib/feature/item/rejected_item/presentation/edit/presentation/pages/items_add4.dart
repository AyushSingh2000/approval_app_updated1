...
class editRejectedItemsPage4 extends StatefulWidget {
  const editRejectedItemsPage4({super.key});

  @override
  State<editRejectedItemsPage4> createState() => _editRejectedItemsPage4State();
}

class _editRejectedItemsPage4State extends State<editRejectedItemsPage4> {
  int count = 0;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Obx(() {
              final itemNumberList = Get.find<EditRejectedItemsController>()
                  .itemNumberList
