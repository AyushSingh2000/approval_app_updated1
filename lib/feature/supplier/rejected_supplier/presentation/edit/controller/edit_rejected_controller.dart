...
import '../data/datasource/edit_rejected_data_source_impl.dart';
import '../data/model/rejected_model.dart';

class EditRejectedController_Supplier extends GetxController {
  EditRejectedSupplierDataSourceImpl editRejectedDataSourceImpl =
      EditRejectedSupplierDataSourceImpl();
...
//contact variable
  ...
  RxList<bPAddresses_rejected> addresslist = <bPAddresses_rejected>[].obs;
...
//address ship to
  ...
  Future<void> getBPSeries() async {
    final data = await editRejectedDataSourceImpl.getBPSeries();
  ...
  Future<void> getBPCountries() async {
    final data = await editRejectedDataSourceImpl.getBPCountries();
  ...
  Future<void> getBPStates() async {
    final data = await editRejectedDataSourceImpl.getBPStates();
  ...
  Future<void> getBPCounty() async {
    final data = await editRejectedDataSourceImpl.getBPCounty();
  ...
  Future<PostResponseType> postCustomerData() async {
    ...
    try {
      print(List<bPAddresses_rejected>.from(addresslist).runtimeType);
      print(
        addresslist.toList().runtimeType,
      );
      EditRejectedModel bp_postModel = EditRejectedModel(
      ...
      var res = await editRejectedDataSourceImpl.postBP_master(bp_postModel);
