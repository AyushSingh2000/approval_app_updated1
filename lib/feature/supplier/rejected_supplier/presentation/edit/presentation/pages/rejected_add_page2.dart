...
class EditRejectedSupplierPage2 extends StatefulWidget {
  const EditRejectedSupplierPage2({super.key});

  @override
  State<EditRejectedSupplierPage2> createState() =>
      _EditRejectedSupplierPage2State();
}

class _EditRejectedSupplierPage2State extends State<EditRejectedSupplierPage2> {
  @override
