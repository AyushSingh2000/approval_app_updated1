                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (ac.res
                                                                      ...
                                                                      ScaffoldMessenger.of(
                                                                              context)
                                                                          .showSnackBar(
                                                                              const SnackBar(content: Text('Successfully Approved')));
                                                                      Navigator.of(
                                                                              context)
                                                                          .pop();
                                                                      ac.sendEmail(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (ac.res
                                                                      ...
                                                                      ScaffoldMessenger.of(
                                                                              context)
                                                                          .showSnackBar(
                                                                              const SnackBar(content: Text('Successfully Rejected')));
                                                                      Navigator.of(
                                                                              context)
                                                                          .pop();
                                                                      ac.sendEmail(
                                                                          subject:
                                                                              ' Supplier Master Creation Request Rejected | Rejected By --',
                                                                          message:
                                                                              'We have rejected the new Supplier Master and below are the details of the Supplier along with the comments for your immediate reference.',
                                                                          cvi:
                                                                              'Supplier',
                                                                          reqestOrApproval:
                                                                              'Approved By',
                                                                  ...
                                                                  child: ac.load2
                                                                      ...
                                                                      : const Text(
                                                                          'Reject',
                                                                          style:
                                                                              TextStyle(color: AppColors.gradientColor1),
                                                                        ),
                                                                ),
                                                              ),
                                                            )
